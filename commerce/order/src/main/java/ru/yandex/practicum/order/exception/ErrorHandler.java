...
public class ErrorHandler {
    ...
    public ErrorResponse handleOrderNotFound(OrderNotFoundException e) {
        ...
        return new ErrorResponse(ErrorType.ORDER_NOT_FOUND, e.getMessage(), HttpStatus.NOT_FOUND.value());
    }
    ...
    public ErrorResponse handleNoOrder(NoOrderFoundException e) {
        ...
        return new ErrorResponse(ErrorType.ORDER_NOT_FOUND, e.getMessage(), HttpStatus.BAD_REQUEST.value());
    }
