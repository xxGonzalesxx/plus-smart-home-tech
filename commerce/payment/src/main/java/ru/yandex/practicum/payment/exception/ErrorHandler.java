...
public class ErrorHandler {
    ...
    public ErrorResponse handleNotFound(PaymentNotFoundException e) {
        ...
        return new ErrorResponse(ErrorType.PAYMENT_NOT_FOUND, e.getMessage(), HttpStatus.NOT_FOUND.value());
    }
    ...
    public ErrorResponse handleNotEnoughInfo(NotEnoughInfoInOrderToCalculateException e) {
        ...
        return new ErrorResponse(ErrorType.NOT_ENOUGH_INFO, e.getMessage(), HttpStatus.BAD_REQUEST.value());
    }
